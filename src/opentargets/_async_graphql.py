"""Async GraphQL executor: sends queries, handles pagination and errors."""
...
class AsyncGraphQLClient:
    """Low-level async GraphQL client wrapping ``httpx.AsyncClient``.

    Args:
        base_url: GraphQL endpoint URL.
        timeout: Request timeout in seconds.
        http_client: Optional pre-configured :class:`httpx.AsyncClient` to reuse.
    """
    ...
    async def execute(
        ...
        return await with_retry_async(_do_request)
